          ...
          <div>
                    ...
                    <tbody className="divide-y">
                      {(product.tiers[0]?.minQuantity ?? 1) > 1 && (
                        ...
                        >
                          ...
                          <td className="px-4 py-2 text-zinc-500">{t("detail.retail")}</td>
                        </tr>
                      )}
            ...
            {specification && specification.rows.length > 3 ? (
              ...
              <p className="mt-8 rounded-2xl bg-zinc-100 p-5">
                Product information is being prepared. Contact support for a
                confirmed compatibility check before purchase.
              </p>
            )}
            ...
            {specification && (
            <div className="mt-12">
              <h2 className="text-3xl font-bold">{specification.title}</h2>
              <p className="mt-2 text-sm text-zinc-500">
                Only specifications relevant to this product category are shown.
              </p>
