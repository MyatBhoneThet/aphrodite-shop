...
const LIMITS: Record<string, number> = {
  ...
  oauth: 20,
  // The signed-out delivery lookup. Low on purpose: it is the one endpoint
  // that answers questions about an order without a session, so guessing an
  // order code against a phone number has to stay impractical.
  track: 10,
  chat: 30,
