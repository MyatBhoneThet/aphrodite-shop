...
export const translations = {
  ...
  // customers here say "Laptop", "Accessories", "PC Parts".
  "nav.laptops": { en: "Laptops", my: "Laptops" },
  "nav.accessories": { en: "Accessories", my: "Accessories" },
  "nav.pcParts": { en: "PC Parts", my: "PC Parts" },
  "nav.findLaptop": { en: "Find Laptop", my: "Find Laptop" },
  "nav.pcBuilder": { en: "PC Builder", my: "PC Builder" },
  ...
  "login.newHere": { en: "New here?", my: "အသစ်လား?" },
  "login.createAccount": { en: "Create an account", my: "အကောင့် အသစ်ဖွင့်ရန်" },
  ...
  "return.step1": { en: "Select the item", my: "ပစ္စည်းကို ရွေးပါ" },
  "return.step2": { en: "Describe the problem", my: "ပြဿနာကို ဖော်ပြပါ" },
  "return.step3": { en: "Choose what you want", my: "လိုချင်သည်ကို ရွေးပါ" },
  "return.step1Help": {
    en: "Return only the item that has a problem. The rest of your order is not affected.",
    my: "ပြဿနာရှိသော ပစ္စည်းကိုသာ ပြန်ပို့ပါ။ ကျန်အော်ဒါကို ထိခိုက်မည် မဟုတ်ပါ။",
  },
