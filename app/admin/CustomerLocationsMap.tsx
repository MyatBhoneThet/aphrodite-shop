...
export default function CustomerLocationsMap({ pins, focus }: { pins: LocationPin[]; focus: string | null }) {
  ...
  return <div>
    <div ref={container} role="region" aria-label="Map of shared customer device locations" className="relative z-0 h-96 w-full overflow-hidden rounded-xl border bg-zinc-100" />
