...
export default function PricingPanel() {
  ...
  return (
    <section className="mt-6 space-y-6">
      ...
      <div className="rounded-2xl bg-white shadow-sm ring-1 ring-zinc-100">
        <div className="border-b px-5 py-4">
          ...
          <p className="text-sm text-zinc-500">
            Wholesale accounts are assigned to one price list; inactive lists
      ...
      <div className="rounded-2xl bg-white shadow-sm ring-1 ring-zinc-100">
        <div className="border-b px-5 py-4">
          <h2 className="font-bold">
            Quantity Tiers{activeList ? ` — ${activeList.name}` : ""}
          </h2>
          <p className="text-sm text-zinc-500">
            The tier with the highest minimum quantity ≤ the ordered quantity
            applies. Below every tier the retail price is used.
          </p>
        </div>

        <form onSubmit={addTier} className="flex flex-wrap items-end gap-3 border-b p-5">
          <div>
            <label className="mb-1 block text-xs font-semibold">Product</label>
            <select
          ...
          <div>
            <label className="mb-1 block text-xs font-semibold">Min quantity</label>
            <input
              type="number"
              min={1}
            ...
            <table className="w-full min-w-[720px] text-left text-sm">
              <thead className="bg-zinc-50 text-xs uppercase text-zinc-500">
                <tr>
                  ...
                  <th className="p-4">Min quantity</th>
      ...
      <div className="rounded-2xl bg-white shadow-sm ring-1 ring-zinc-100">
        <div className="border-b px-5 py-4">
          <h2 className="font-bold">Price Preview</h2>
          <p className="text-sm text-zinc-500">
            Check what a retail customer or a wholesale account on a given
            price list pays for a quantity.
          </p>
        </div>
          ...
          {preview && (
            <div className="rounded-2xl bg-zinc-50 px-5 py-3 text-sm">
              <p className="font-bold">
                {formatCurrency(preview.unitPrice)}/unit ·{" "}
                {formatCurrency(preview.lineTotal)} total
              </p>
