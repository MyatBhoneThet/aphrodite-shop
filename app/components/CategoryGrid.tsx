const categories = [
  ...
  { en: "Accessories", my: "ဆက်စပ်ပစ္စည်းများ", icon: "⌨️", href: "/catalog/accessories" },
  { en: "PC Parts", my: "ကွန်ပျူတာ အစိတ်အပိုင်းများ", icon: "🖥️", href: "/catalog/pc-parts" },
  { en: "Build a PC", my: "ကွန်ပျူတာ ဆင်ရန်", icon: "🧩", href: "/pc-builder" },
];
