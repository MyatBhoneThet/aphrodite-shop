        ...
        <div className="flex items-center gap-3 text-sm">
          ...
          {currentUser ? (
            <div className="flex items-center gap-2">
              <Link href="/wishlist" className="hover:text-red-600">♡ {wishlistCount}</Link>
              <Link href="/cart" className="hover:text-red-600">🛒 {cartCount}</Link>
              <Link href="/orders" className="hidden hover:text-red-600 lg:inline">Orders</Link>
              {currentUser.role !== "admin" && (
                <Link
                  href="/settings"
                  className="hidden hover:text-red-600 lg:inline"
                >
                  Settings
                </Link>
              )}
            ...
            <>
              <Link href="/register" className="hidden rounded-full border px-4 py-2 sm:inline">Register</Link>
              <Link href="/login" className="rounded-full bg-red-600 px-4 py-2 text-white">Login</Link>
            </>
          )}
        </div>
      </div>
